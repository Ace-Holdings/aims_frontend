...
export default function Payslips() {
    ...
    const generatePaySlipPdf = (payslip: any) => {
        ...
        const deductionsData = payslip.deductions.map((deduction) => [
            ...
            deduction.amount.toLocaleString("en-US", { style: "currency", currency: "MWK" }),
        ]);

        const deductionTableStartY = doc.lastAutoTable.finalY + 10;
        doc.text("DEDUCTIONS", 14, deductionTableStartY);
        autoTable(doc, {
            startY: deductionTableStartY + 5,
            head: [["DESCRIPTION", "AMOUNT"]],
            body: deductionsData,
            theme: "grid",
            styles: { fontSize: 10, cellPadding: 2 },
        ...
        const netPayStartY = doc.lastAutoTable.finalY + 10;
        doc.setFont("helvetica", "bold");
        ...
        doc.text(`DATE: ${new Date().toLocaleDateString()}`, 14, netPayStartY + 20);

        doc.save(`Payslip_${payslip.employeeName}.pdf`);
    }

    const dummyInvoice = () => {
        const payslipData = {
            payDate: "25 JANUARY, 2025",
            employeeName: "BOSCO CHINTHEWERE",
            empCode: "12345",
            jobTitle: "GROUND LABOURER",
            category: "A",
            accountName: "BOSCO CHINTHEWERE",
            accountNumber: "123456789",
            branchName: "Main Branch",
            earnings: [
                { description: "Basic Salary", amount: 100000 },
                { description: "Overtime", amount: 50000 },
                { description: "Risk Allowance", amount: 30000 },
                { description: "Medical Insurance", amount: 20000 },
                { description: "Transport & Allowance", amount: 30000 },
                { description: "Airtime & Data", amount: 20000 },
            ],
            deductions: [
                { description: "PAYE", amount: 0 },
                { description: "Medical Aid", amount: 0 },
                { description: "Pension", amount: 0 },
                { description: "Loan", amount: 0 },
                { description: "Advance", amount: 0 },
                { description: "Unpaid Leave", amount: 0 },
            ],
            netPay: 250000,
        };
