    ...
    const generatePDF = () => {
        ...
        const rows = loans.map((loan) => {
            ...
            const monthsElapsed = Math.max(
                0,
                (currentDate.getFullYear() - grantedDate.getFullYear()) * 12 +
                (currentDate.getMonth() - grantedDate.getMonth())
            );

            const totalPaid = monthsElapsed * loan.monthlyDeduction;
            const isPaid = totalPaid >= loan.amount;
            const paymentStatus = isPaid ? "Paid" : "Not Paid";

            return [
                loan.loanId,
                loan.applicant?.username || "Unknown",
                ...
                <div
                    ...
                    <div className="ml-6 mt-10 font-custom">
                        ...
                        <div className='flex items-center gap-4'>
                            ...
                            <div className='w-2'/>
                            <button
                                className="btn bg-blue-500 hover:bg-blue-400 text-white font-medium py-4 px-8 rounded-lg flex items-center gap-2 relative"
                            ...
                            >
                                ...
                                >
                                    <path
                                        strokeLinecap="round"
                                        strokeLinejoin="round"
                                        d="M12 8c-1.5 0-3 .5-3 2s1.5 2 3 2 3 .5 3 2-1.5 2-3 2m0-8v8m0-12v2m0 10v2"
                                    />
                                    <line
                                        x1="4"
                                        y1="4"
                                ...
                                {hasPendingRequests && (
                                    <ExclamationCircleIcon
                                        className="w-5 h-5 text-red-500 absolute -top-1 -right-1 "
                                        title="New pending loan requests"
                                    />
                                )}
                            </button>
                            <div className='w-2'/>
                ...
                <div className="fixed inset-0 bg-black font-custom bg-opacity-50 flex backdrop-blur-sm justify-center items-center z-50">
                    <div className="relative bg-white rounded-lg shadow-lg w-full max-w-3xl p-6">
                        ...
                        <div className="flex border-b-2 mb-6">
                            ...
                            <button
                                className={`relative flex-1 text-center pb-2 text-lg ${
                            ...
                            >
                                ...
                                {hasPendingRequests && (
                                    <ExclamationCircleIcon
                                        className="w-5 h-5 text-red-500 absolute top-0 right-2 "
                                        title="New pending loan requests"
                                    />
                                )}
                            </button>
