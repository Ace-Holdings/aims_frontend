...
export default function ManagerPayslips() {
    ...
    const generatePaySlipPdf = (payslip: any) => {
        ...
        doc.addImage(logoBase64, "PNG", 158, 1, 50, 30);
        ...
        doc.text(`PAY DATE: ${payslip.payDate}`, 14, 27);
        doc.text(`EMP NAME: ${payslip.employeeName}`, 14, 33);
        doc.text(`EMP CODE: ${payslip.empCode || "N/A"}`, 14, 39);
        doc.text(`JOB TITLE: ${payslip.jobTitle}`, 14, 45);
        doc.text(`CATEGORY: ${payslip.category}`, 14, 51);

        doc.text(`ACCOUNT NAME: ${payslip.accountName}`, 120, 33);
        doc.text(`ACCOUNT NO.: ${payslip.accountNumber}`, 120, 39);
        doc.text(`BRANCH NAME: ${payslip.branchName}`, 120, 45);
        ...
        const loanSectionY = (doc.lastAutoTable?.finalY || 0) + 20;
    ...
    const handlePaySlipSubmit = async (e: any) => {
        ...
        const payslipData = {
            ...
            category: selectedEmployee.category || "N/A",
            accountName: selectedEmployee.username,
