                ...
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-30 text-black font-custom backdrop-blur-sm z-50">
                    <div className="bg-white p-6 rounded-lg shadow-lg max-w-3xl mx-auto">
                        ...
                        <div className="flex flex-wrap gap-4">
                            ...
                            <div>
                                <strong>Total earnings:</strong> {selectedSlip.earnings}
                            </div>
                            <div>
                                <strong>Total deductions:</strong> {selectedSlip.deductions}
                            </div>
                            <div>
                                <strong>Date:</strong> {selectedSlip.date}
                            </div>
                        </div>
