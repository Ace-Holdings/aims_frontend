...
export default function EmployeeSidebar({ isCollapsed, toggleSidebar }: any) {
    ...
    return (
        <div className={`sticky bg-gradient-to-b from-cyan-700 to-teal-300 text-white transition-all duration-300 ease-in-out h-screen ${isCollapsed ? "w-16" : "w-64"}`}>
                        ...
                        return (
                            <li key={index}>
                                <button
                                    ...
                                    } hover:bg-cyan-600 focus:outline-none relative`}
                                >
                                    {/* Active vertical bar */}
                                    <span
